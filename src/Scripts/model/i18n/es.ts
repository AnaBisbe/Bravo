...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.errorReportConnectionUnsupportedAnalysisServecesCompatibilityMode]: "El modo de compatibilidad de la instancia de Power BI Desktop Analysis Services no es PowerBI.",
        [_.errorReportConnectionUnsupportedAnalysisServecesConnectionNotFound]: "No se encontró la conexión TCP de Power BI Desktop Analysis Services.",
        [_.errorReportConnectionUnsupportedAnalysisServecesProcessNotFound]: "No se encontró el proceso de instancia de Power BI Desktop Analysis Services.",
        ...
        [_.errorReportConnectionUnsupportedDatabaseCollectionIsEmpty]: "La instancia de Power BI Desktop Analysis Services no contiene ninguna base de datos. Intente conectarse al informe utilizando el ícono de Bravo en las Herramientas Externas de Power BI Desktop.",
        ...
        [_.errorReportConnectionUnsupportedProcessNotYetReady]: "El proceso de Power BI Desktop está abriendo o el Servicio de Analisis aún no está disponible.",
        ...
        [_.errorVpaxFileContainsCorruptedData]: "El formato del archivo VPAX no es válido o contiene datos corruptos.",
